import { getProgressPhotos } from '@/lib/data'
...
export default async function PhotosPage() {
  ...
  return (
    <div className="space-y-4 animate-fade-in">
      <PageHeader title="Progress Photos" subtitle={`${photos.length} photos`} action={<PhotosClient />} />
      <div className="px-4">
        {photos.length === 0 ? (
          <div className="stat-card text-center py-12">
            <p className="text-sm text-muted-foreground">No photos yet. Tap + to upload your first progress photo.</p>
          </div>
        ) : (
